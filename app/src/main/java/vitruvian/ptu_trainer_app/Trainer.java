...
public class Trainer extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Character_Name_View.setText(trainerName);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        //Load shared pref file, and clear all stats saved in that file, executes on click of MenuItem with matching ID
        if (id == R.id.clear_saved_stats) {
            this.getSharedPreferences("savedTrainerStats", Context.MODE_PRIVATE).edit().clear().apply();
    ...
    public class SampleFragmentPagerAdapter extends FragmentPagerAdapter  {
        private String tabTitles[] = new String[] { "Skills", "Combat", "Lvl 1 Stats" };
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    fragment = Fragment.instantiate(Trainer.this, CurrentStats.class.getName());
                    break;
                case 1:
                    fragment = Fragment.instantiate(Trainer.this, CombatStagesTrainer.class.getName());
                    break;
                case 2:
                    fragment = Fragment.instantiate(Trainer.this, BaseStatsTrainer.class.getName());
                    break;
            }
            return fragment;
        }
