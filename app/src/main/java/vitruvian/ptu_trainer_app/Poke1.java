...
public class Poke1 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editorID.putInt(getString(R.string.unqiueID), 1);
        editorID.apply();
        ...
        String type = savedPoke1Stats.getString("Type", "colorPrimary");
        switch (type) {
            case "Bug":
        ...
        Character_Name_View.setText(poke1Name);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.clear_saved_stats) {
            this.getSharedPreferences("savedPoke1Stats", Context.MODE_PRIVATE).edit().clear().apply();
    ...
    public class SampleFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    fragment = Fragment.instantiate(Poke1.this, CombatStagesPoke.class.getName());
                    break;
                case 1:
                    fragment = Fragment.instantiate(Poke1.this, BaseStatsPoke.class.getName());
                    break;
            }
            return fragment;
        }
