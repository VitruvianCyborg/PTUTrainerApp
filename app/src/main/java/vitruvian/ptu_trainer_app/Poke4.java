...
public class Poke4 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editorID.putInt(getString(R.string.unqiueID), 4);
        editorID.apply();
        ...
        String type = savedPoke4Stats.getString("Type", "colorPrimary");
        if (type.equals("Bug")){
        ...
        Character_Name_View.setText(poke4Name);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.clear_saved_stats) {
            this.getSharedPreferences("savedPoke4Stats", Context.MODE_PRIVATE).edit().clear().apply();
    ...
    public class SampleFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    fragment = Fragment.instantiate(Poke4.this, CombatStagesPoke.class.getName());
                    break;
                case 1:
                    fragment = Fragment.instantiate(Poke4.this, BaseStatsPoke.class.getName());
                    break;
            }
            return fragment;
        }
