...
public class Poke5 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editorID.putInt(getString(R.string.unqiueID), 5);
        editorID.apply();
        ...
        String type = savedPoke5Stats.getString("Type", "colorPrimary");
        if (type.equals("Bug")){
        ...
        Character_Name_View.setText(poke5Name);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.clear_saved_stats) {
            this.getSharedPreferences("savedPoke5Stats", Context.MODE_PRIVATE).edit().clear().apply();
    ...
    public class SampleFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    fragment = Fragment.instantiate(Poke5.this, CombatStagesPoke.class.getName());
                    break;
                case 1:
                    fragment = Fragment.instantiate(Poke5.this, BaseStatsPoke.class.getName());
                    break;
            }
            return fragment;
        }
